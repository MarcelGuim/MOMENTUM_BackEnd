        ...
        Appointment: {
          ...
          properties: {
            ...
            customAddress: {
              type: 'string',
              description:
                'Human-readable address when not using a Location reference',
              example: '123 Main St, Apt 4B, New York',
            },
            customUbicacion: {
              type: 'object',
              description:
                'GeoJSON Point coordinates when not using a Location reference',
              properties: {
                type: {
                  type: 'string',
                  enum: ['Point'],
          ...
          properties: {
            ...
            serviceType: {
              ...
              items: {
                type: 'string',
                description:
                  'Un dels valors definits a locationServiceType (ex: "massage", "tattoo", "gym workout", etc.)',
              },
              ...
              items: {
                ...
                properties: {
                  day: {
                    type: 'string',
                    description:
                      'Un dels dies de la setmana: monday, tuesday, etc.',
                    example: 'monday',
                  },

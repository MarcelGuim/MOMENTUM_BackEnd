...
export async function hardDeleteAppointmentById(
  req: Request,
  res: Response
): Promise<Response> {
  try {
...
export async function softDeleteAppointmentById(
  req: Request,
  res: Response
): Promise<Response> {
  try {
    ...
    return res
      .status(500)
      .json({ message: 'Failed to soft delete appointment' });
  }
}

// Restaurar cita (undelete)
export async function restoreAppointmentById(
  req: Request,
  res: Response
): Promise<Response> {
  try {

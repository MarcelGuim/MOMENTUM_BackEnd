...
export async function getPeopleWithWhomUserChatted(
  req: Request,
  res: Response
): Promise<Response> {
...
export async function getPeopleWithWhomWorkerChatted(
  req: Request,
  res: Response
): Promise<Response> {
  try {
    ...
    console.log(
      'getting people with whom worker chatted, worker ID is: ',
      workerId
    );
